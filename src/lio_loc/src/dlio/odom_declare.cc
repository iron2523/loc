...
void dlio::OdomNode::declare_global_param() {
    ...
    map_path_ = "/home/xc/loc_ws/src/lio_loc/map/GlobalMap.pcd";
    declare_param(&nh, "map_path", map_path_, map_path_);
    full_map_path_ = "/home/xc/loc_ws/src/lio_loc/map/FullMap.pcd";
    declare_param(&nh, "map_path", full_map_path_, full_map_path_);
    init_pose_path_ = "/home/xc/loc_ws/src/lio_loc/map/init_pose.yaml";
