...
public:
    ...
    */
    void odometryHandler(const nav_msgs::Odometry::ConstPtr& odomMsg)
    {
        ...
        state_info.accel_bias.y = accelBias(1);
        state_info.accel_bias.z = accelBias(2);
        state_info.gyro_bias.x = gyroBias(0);
        state_info.gyro_bias.y = gyroBias(1);
        state_info.gyro_bias.z = gyroBias(2);
        
        // 时间戳信息
        state_info.header.stamp = odomMsg->header.stamp;
        pubstate_info.publish(state_info);
