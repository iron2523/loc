// Generated by gencpp from file dlio_loc/cloud_info.msg
// DO NOT EDIT!


#ifndef DLIO_LOC_MESSAGE_CLOUD_INFO_H
#define DLIO_LOC_MESSAGE_CLOUD_INFO_H
...
struct cloud_info_
{
  ...
  typedef boost::shared_ptr< ::dlio_loc::cloud_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dlio_loc::cloud_info_<ContainerAllocator> const> ConstPtr;

}; // struct cloud_info_

typedef ::dlio_loc::cloud_info_<std::allocator<void> > cloud_info;

typedef boost::shared_ptr< ::dlio_loc::cloud_info > cloud_infoPtr;
typedef boost::shared_ptr< ::dlio_loc::cloud_info const> cloud_infoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dlio_loc::cloud_info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dlio_loc::cloud_info_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dlio_loc::cloud_info_<ContainerAllocator1> & lhs, const ::dlio_loc::cloud_info_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::dlio_loc::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dlio_loc::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dlio_loc::cloud_info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dlio_loc::cloud_info_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dlio_loc::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dlio_loc::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dlio_loc::cloud_info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dlio_loc::cloud_info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb654dbfca2e5288eULL;
  static const uint64_t static_value2 = 0xff9e25937cb8519eULL;
};

template<class ContainerAllocator>
struct DataType< ::dlio_loc::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dlio_loc::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Cloud Info\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dlio_loc::cloud_info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dlio_loc::cloud_info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dlio_loc::cloud_info_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DLIO_LOC_MESSAGE_CLOUD_INFO_H
